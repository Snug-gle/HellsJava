...
<div class="col-md-12">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form action="<c:url value = "/notice/modify"/>" method="post" name="noticeForm" class="form-horizontal" role="form">
               	
               	<input type="hidden" name="noticeServiceSortation" value="1">
               	<input type="hidden" name="noticeServiceStatus" value="1">
               	<input type="hidden" name="noticeServiceNo" value="${notice.noticeServiceNo}">              	
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <textarea class="form-control" name="noticeServiceContent" placeholder="내용">${notice.noticeServiceContent}</textarea>
                    </div>
                </div>
